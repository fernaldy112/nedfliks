<nav class="flex items-center justify-center w-full bg-black">
    <div class="text-sm">
      <a href="/tv_shows" class="inline-block text-white hover:text-white md:mx-20 sm:mx-10 mx-3 mb-2 md:text-lg sm:text-md text-sm">
        TV Shows
      </a>
